...
export const GenerateIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M9 4.5a.75.75 0 01.75.75v1.5a.75.75 0 01-1.5 0V5.25A.75.75 0 019 4.5zm5.854 5.054a.75.75 0 00-1.06-1.06L9 12.25v2.546l3.794-3.793zM12.25 15.016L9 18.266V20.25h1.984l3.266-3.266-2.984-2.968zM15 4.5a.75.75 0 01.75.75v1.5a.75.75 0 01-1.5 0V5.25A.75.75 0 0115 4.5zM12 2.25a.75.75 0 01.75.75v1.5a.75.75 0 01-1.5 0V3A.75.75 0 0112 2.25zM5.25 9a.75.75 0 00-1.5 0v6a.75.75 0 001.5 0V9zM3.75 12a.75.75 0 01.75-.75h1.5a.75.75 0 010 1.5H4.5a.75.75 0 01-.75-.75zm15.75-3a.75.75 0 00-1.5 0v6a.75.75 0 001.5 0V9zm-1.5.75a.75.75 0 01.75-.75h1.5a.75.75 0 010 1.5H18a.75.75 0 01-.75-.75z" clipRule="evenodd" />
        <path d="M12 21a8.969 8.969 0 005.46-1.874.75.75 0 00-1.127-1.002A7.469 7.469 0 0112 19.5a7.469 7.469 0 01-4.333-1.376.75.75 0 00-1.127 1.002A8.969 8.969 0 0012 21z" />
    </svg>
);
...
export const ClipboardIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M10.5 3A2.5 2.5 0 008 5.5v2.33a3.003 3.003 0 01.84-1.424 2.5 2.5 0 013.32 0c.977.977 1.28 2.25 1.018 3.454l.42 1.468a.75.75 0 01-1.42.408l-.419-1.468a1.5 1.5 0 10-2.66 0l-.42 1.468a.75.75 0 01-1.42-.408l.42-1.468c-.262-1.204.041-2.477 1.018-3.454a2.5 2.5 0 013.32 0A3.003 3.003 0 0116 7.83V5.5A2.5 2.5 0 0013.5 3h-3zm-2.5 5.5a1.5 1.5 0 00-1.5 1.5v8.5a1.5 1.5 0 001.5 1.5h8.5a1.5 1.5 0 001.5-1.5v-8.5a1.5 1.5 0 00-1.5-1.5h-8.5z" clipRule="evenodd" />
        <path d="M8 6.5a1 1 0 011-1h6a1 1 0 011 1v.75a.75.75 0 01-1.5 0V7.5h-5V10a.75.75 0 01-1.5 0V6.5z" />
    </svg>
);
